...
//		+ " ON " + DbHelper.TABLE_SECTIONS + "." + DbHelper.COLUMN_ID + " = " + DbHelper.TABLE_LEVELS + "."
...
//    }
	...
	for (Level level : section.levels) {
	    ...
	    levelValues.put(DbHelper.COLUMN_STATUS, Level.STATUS_LEVEL_UNCLEAR);
	    levelValues.put(DbHelper.COLUMN_FK_SECTION, sectionInsertId);
	    long levelInsertId = mDbHelper.getWritableDatabase().insert(DbHelper.TABLE_LEVELS, null,
		    levelValues);
		...
		mDbHelper.getWritableDatabase().insert(DbHelper.TABLE_HINTS, null,
			hintValues);
	    }
	}
	...
	String sqlQuery = "SELECT " + DbHelper.TABLE_SECTIONS + "."
		...
		+ DbHelper.TABLE_SECTIONS + " LEFT JOIN "
